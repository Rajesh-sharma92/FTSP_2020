...
''' If we only perform the fit_transform on the features then what will be results. 
...
# NOTE :- As we have seen there is NO changes on dataset while performing Scalling on features only.
# or feattures_train & features_test too.
# We will be getting some Results always as per Dataset.
