...
dataset = pd.read_csv(r'E:\ML Code Challenges\ML CSV Files\tree_addhealth.csv')  
...
print(accuracy_score(labels_test, labels_pred)) # 0.777777777
...
print('The Score :' ,(17+0)/(17+0+0+1))
# The Score : 0.9444444444444444
