...
fp = open('E:\ML Code Challenges\ML CSV Files\Auto_mpg.txt','r')
...
df.to_csv('E:\ML Code Challenges\ML CSV Files\Auto_mpg.csv', encoding='utf-8')
...
dataset = pd.read_csv("E:\ML Code Challenges\ML CSV Files\Auto_mpg.csv" , names=col_names , header = None)
...
"""
dataset = pd.read_csv("E:\ML Code Challenges\ML CSV Files\Auto_mpg.csv") 

dataset.isnull().any(axis=0) # No Null values are there.
