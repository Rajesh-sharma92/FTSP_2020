...
data.execute ("""CREATE TABLE employees(
          id INTEGER,
          first  TEXT,
          last TEXT,
          pay INTEGER
...
data.execute("INSERT INTO employees VALUES (01,'Sylvester', 'Fernandes', 50000)")
data.execute("INSERT INTO employees VALUES (02,'Yogendra', 'Singh', 70000)")
data.execute("INSERT INTO employees VALUES (03,'Rohit', 'Mishra', 30000)")
data.execute("INSERT INTO employees VALUES (04,'Kunal', 'Vaid', 30000)")
data.execute("INSERT INTO employees VALUES (05,'Devendra', 'Shekhawat', 30000)")
